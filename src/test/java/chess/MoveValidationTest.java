...
public class MoveValidationTest {
    ...
    public void testRookMove() {
        ...
        assertEquals(true, rook.isValidMove(new Position("h1"), new Position("h2"))); //Vertical one sheet move
        assertEquals(true, rook.isValidMove(new Position("h2"), new Position("g2"))); //Horizontal one sheet move
        assertEquals(true, rook.isValidMove(new Position("g2"), new Position("a2"))); //Horizontal multiple sheets move
        assertEquals(true, rook.isValidMove(new Position("a2"), new Position("a8"))); //Vertical multiple sheets move
        assertEquals(false, rook.isValidMove(new Position("a8"), new Position("h1"))); //Diagonal does not allowed
    }
    ...
    public void testWhitePawnMove() {
        ...
        assertEquals(true, pawn.isValidMove(new Position("a2"), new Position("a3"))); //1 sheet forward
        assertEquals(true, pawn.isValidMove(new Position("a2"), new Position("a4"))); //2 sheet forward
        
        assertEquals(false, pawn.isValidMove(new Position("a2"), new Position("a1"))); //1 sheet back  should not allow
